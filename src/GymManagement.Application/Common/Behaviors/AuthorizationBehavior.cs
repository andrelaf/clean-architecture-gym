...
public class AuthorizationnBehavior<TRequest, TResponse>(ICurrentUserProvider _currentUserProvider)
        ...
        CancellationToken cancellationToken)
    {
      var authorizationAttributes = request.GetType()
        ...
        if (requiredPermissions.Except(currentUser.Permissions).Any())  
            return (dynamic)Error.Unauthorized(description: "Use is forbiden from taking this action.");
